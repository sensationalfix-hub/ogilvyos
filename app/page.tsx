        ...
        return <>
          ...
          <div className="sheet-body employee-body">
            <section className="employee-kpis">
              ...
              <article><span>TAREAS</span><strong>{selectedPerson.taskScore?.toFixed(1) ?? "—"}<small>/5</small></strong><p>Ejecución</p></article>
              <article><span>PROYECTOS</span><strong>{selectedPerson.projectScore?.toFixed(1) ?? "—"}<small>/5</small></strong><p>Calidad final</p></article>
